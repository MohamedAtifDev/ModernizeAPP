    ...
    public partial class builddb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_courseBranches", x => new { x.branchid, x.courseid });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    courseid = table.Column<int>(type: "int", nullable: false),
                    AssigmentDate = table.Column<DateTime>(type: "Date", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_studentCourses_payments_paymentid",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_studentCourses_paymentid",
                table: "studentCourses",
                column: "paymentid",
                unique: true);
        }
